...
app.get("/", (req, res) => {
  ...
  //PRUEBA// Ruta para el formulario de inserción de curso
app.get("/insertForm", (req, res) => {
    res.send(`
      <!DOCTYPE html>
      <html lang="es">
  ...
  // Ruta para el formulario de actualización de curso
  app.get("/updateForm", (req, res) => {
    res.send(`
      <!DOCTYPE html>
      <html lang="es">
  ...
  // Ruta para el formulario de actualización de un campo específico
  app.get("/patchForm", (req, res) => {
    res.send(`
      <!DOCTYPE html>
      <html lang="es">
  ...
  // Ruta para el formulario de eliminación de curso
  app.get("/deleteForm", (req, res) => {
    res.send(`
      <!DOCTYPE html>
      <html lang="es">
